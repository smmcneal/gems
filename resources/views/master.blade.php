...
<head>
    <meta charset="utf-8">
    <title>@yield('title', 'Gem & Mineral Source')</title>
...
<body>
        ...
        <nav class="navbar navbar-default navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="{{ url('/') }}">Gem & Mineral Source</a>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                       aria-expanded="false"><i class="fa fa-user" aria-hidden="true"></i> My Account <span
                                class="caret"></span></a>
    ...
    <footer>
      <div class="container">
        <p class="text-muted">Copyright 2018</a></p>
      </div>
    </footer>
